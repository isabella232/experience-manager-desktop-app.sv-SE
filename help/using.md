...
![Arbetsflöden och uppgifter du kan utföra med [!DNL Experience Manager] datorprogramArbetsflöden och](assets/aem_desktop_app_usecases_v2.png "uppgifter du kan utföra med Adobe Experience Manager datorprogram")Ladda ned [den här](assets/aem_desktop_app_usecases_print.pdf) utskriftsklara PDF-filen.
...
Åtgärden **[!UICONTROL Reveal File]** öppnar en lokal nätverksresurs som endast visar resurser som är tillgängliga lokalt, det vill säga resurser som har visats, hämtats eller öppnats/redigerats med appen. Den lokala nätverksresursen överför inga ändringar till Experience Manager. Om du vill överföra ändringarna använder du **[!UICONTROL Upload Changes]** eller **[!UICONTROL Upload]** gör något i appen.
...
När du är klar med redigeringarna visas de ändrade resursernas **[!UICONTROL Edited Locally]** status. Alla ändringar som sparas i resurserna är bara lokala tills du överför ändringarna till Experience Manager. Om du vill överföra en enskild resurs eller ett fåtal resurser klickar du på **[!UICONTROL Upload Changes]** något av alternativen för en resurs. En version av resursen skapas i Experience Manager. Med webbgränssnittet i [!DNL Assets]kan du se resurshistorik i [tidslinjevyn](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/activity-stream.html).
...
>[!NOTE]
>
>Om filerna inte kan överföras och du ansluter till Experience Manager 6.5.1 eller senare ska du läsa den här [felsökningsinformationen](troubleshoot.md#upload-fails).
...
Se [Överför resurser till Experience Manager](#upload-and-add-new-assets-to-aem)om du vill visa en lista över resurser som överförts under en viss session.

## Avancerat arbetsflöde: starta från [!DNL Assets] webbgränssnittet {#adv-workflow-start-from-aem-ui}
...
Om en lokalt hämtad resurs uppdateras på Experience Manager-servern visas programmets **[!UICONTROL Modified remotely]** status. Du kan antingen ta bort din lokala kopia eller uppdatera den lokala kopian genom att klicka på [!UICONTROL Remove] respektive [!UICONTROL Update] . Med länkar i dialogrutan kan du visa båda versionerna av resursen.
...
1. I datorprogrammet finns INDD- **[!UICONTROL Edit]** filen med monterade resurser i Experience Manager.
...
1. Om du vill montera en ny bild i filen InDesign använder du **[!UICONTROL Reveal File]** åtgärden på resursen. Åtgärden hämtar resursen lokalt och öppnar den lokala nätverksresursplatsen i Utforskaren i Windows eller Finder i Mac.
...
När du använder åtgärden för att redigera en resurs i ett datorprogram hämtas resursen lokalt om den inte redan är tillgänglig lokalt. [!UICONTROL Edit] Se [Redigera resurser och överföra uppdaterade resurser till Experience Manager](#edit-assets-upload-updated-assets).

Om programmet är installerat och tillåts att göra det, slutförs åtgärderna när du använder det [!UICONTROL Desktop Actions] från Experience Manager webbgränssnitt. Programmet hämtar resursen först och slutför sedan åtgärden.
