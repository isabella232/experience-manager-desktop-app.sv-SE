...
description: Viktiga funktioner och rekommenderad användning av [!DNL Adobe Experience Manager] datorprogram version 1.10.
...
>[!NOTE]
>
>Innan du läser det här dokumentet kan du granska det övergripande [Bästa praxis för integrering av AEM och Creative Cloud](https://experienceleague.adobe.com/docs/experience-manager-65/assets/administer/aem-cc-integration-best-practices.html) för en översikt över ämnet på högre nivå.
...
## Rekommenderad användning av AEM datorprogram {#recommended-use-of-aem-desktop-app}
...
* **Åtkomst till resursen från skrivbordet**. I den monterade nätverksresursen finns en snabbmeny med en [!UICONTROL More Info] (större förhandsgranskning, viktiga metadata) och möjligheten att öppna en resurs i AEM.
...
* Använd inte AEM datorprogram för att hantera resurser från skrivbordet. AEM skrivbordsapp skapades inte som ersättning för nätverksenheter. Använd följande funktioner i stället:
   ...
   * AEM [!UICONTROL Folder Upload] för att överföra stora, hierarkiska mappar.
...
* Använd inte AEM datorprogram för att migrera stora mängder data från en AEM till en annan. Se [Migreringshandbok](https://experienceleague.adobe.com/docs/experience-manager-65/assets/administer/assets-migration-guide.html) för att planera och utföra resursmigreringar. Datorprogrammet däremot [stöder massöverföring](use-app-v1.md#bulkupload) stort antal resurser för första gången i [!DNL Adobe Experience Manager].
...
* För **större uppdateringar**, t.ex. en ändringsbegäran som kräver en liten kreativ PIA-cykel:
...
Om du vill ha mer information om AEM Assets nätverkskonfiguration kan du läsa [Så här migrerar du resurser i grupp](https://experienceleague.adobe.com/docs/experience-manager-65/assets/administer/assets-migration-guide.html) -dokument. Några av de viktiga aspekter som hjälper användarna att optimera AEM appupplevelsen är:

* **Använd korrekt konfigurerad Dispatcher**. Använd AEM Dispatcher för ytterligare säkerhet och kontrollera att den är konfigurerad för [AEM anslutning till datorprogram till AEM bakom en dispatcher](install-configure-app-v1.md#connect-to-an-aem-instance-behind-a-dispatcher)
...
>[!NOTE]
>
>Om du vill inaktivera förhandsvisningar av ikoner går du till Finder [!UICONTROL View], markera [!UICONTROL View Options]och sedan avmarkera [!UICONTROL Show icon preview] alternativ. Det här fungerar bara för den aktuella mappen. Om du vill göra den till standard klickar du på [!UICONTROL Use as default] i samma dialogruta.
...
* **Uppladdning av resurser med högre prestanda**. Konfigurera [Arbetsflödesmodellen AEM tillgångsuppdatering ska vara övergående](https://experienceleague.adobe.com/docs/experience-manager-65/assets/administer/performance-tuning-guidelines.html).
